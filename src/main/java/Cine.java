...
public class Cine {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("+---------------------------------------------------+");
		System.out.println("|   CINE "+ cine.nom + " v2.2 Compra N Entrades amb fils   |");
		System.out.println("+---------------------------------------------------+");
	...
	public Seient reservaEntradaFil(Pelicula pelicula, Sessio sessio, Sala sala, ArrayList<Seient> seientsAcomprar) {
		Seient seient = null;
		...
		synchronized(this) {
			do {
				System.out.println("<"+ Thread.currentThread().getName() +">"+"\tSeient: ");
				fila = Validacio.validaSencer("<"+ Thread.currentThread().getName() +">"+"\t\t Tria FILA: [1-"+sala.getFiles()+"] ",sala.getFiles());
				columna = Validacio.validaSencer("<"+ Thread.currentThread().getName() +">"+"\t\t Tria SEIENT en la fila: [1-"+sala.getTamanyFila()+"]",sala.getTamanyFila());		
	...
	///////////inici de SYNCHRONIZED ////////////////////
	/////////////////////////////////////////////////////
	synchronized String alliberaSeients(ArrayList<Seient> seientsAcomprar) {
		String mensaje = "";
		for (int i=0; i < seientsAcomprar.size(); i++) {
			//Si el seient ja està ocupat per altre fil, no es pot alliberar
			if (seientsAcomprar.get(i).getDisponibilitat()!= Seient.Estat.OCUPAT) {
	...
	//*********************************************************
	// DEVUELVE UN STRING DE TODAS LAS PELICULAS O QUE NO HAY PELICULAS
	public String llistarPelicules(){
		String peliculas = "";
