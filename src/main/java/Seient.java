...
public class Seient {
	...
	public boolean equals(Object obj) {
		Seient otro = (Seient) obj;
		if (this.getFilaSeient() == otro.getFilaSeient() && this.getNumeroSeient() == otro.getNumeroSeient()) {
			return true;
		}
		return false;
	}
	...
	public boolean verificaSeient() {
		...
		case LLIURE:// LLIURE
			return true;
		case OCUPAT:// OCUPAT
			// System.out.println("\t ERROR Seient:verificaSeient: Seient OCUPAT");
			return false;

		case RESERVAT:// RESERVAT
			// System.out.println("\t ERROR Seient:verificaSeient: Seient RESERVAT,
			// intenta-ho passat un temps");
			return true;
		default:
	...
	public String toString() {
		return "Seient [filaSeient=" + filaSeient + ", numeroSeient=" + numeroSeient + ", disponibilitat="
				+ disponibilitat + "]";
	}
